              ...
              <div className="mt-6 flex flex-col items-center space-y-4 md:mt-0 md:flex-row  md:space-y-0 md:space-x-5">
                ...
                <div className="group relative">
                  ...
                  <button
                    ...
                    className="relative flex items-center space-x-4 divide-gray-600 rounded-lg  px-4 py-2 leading-none text-blue-200 transition duration-200 hover:text-purple-300 bg-black md:px-5 md:py-3"
                  >
                    <svg
                    ...
                    <span className="font-poppins text-sm tracking-wider text-white transition duration-200 group-hover:text-purple-300 md:text-lg">
            ...
            <div className="grid flex-grow items-center gap-0 md:grid-cols-2 md:gap-24 md:pt-12">
              ...
              <div className="col-span-1">
                ...
                <div className="group relative mt-10">
                  ...
                  <button className="relative flex w-full items-center justify-center space-x-4 divide-gray-600 rounded-lg  px-4 py-3 leading-none text-blue-200 transition duration-200 hover:text-purple-300 bg-black md:px-6 md:py-4">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
