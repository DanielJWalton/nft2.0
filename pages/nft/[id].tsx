  ...
  return (
    <Container>
      ...
      <div className="mt-8 flex flex-grow items-center justify-center md:mt-0 md:pt-12">
        <section className="grid w-full grid-cols-2 items-center gap-0 rounded-xl bg-gradient-to-tr from-purple-500/[0.15] to-blue-400/[0.1] p-6 dark:from-purple-800/[0.15] dark:to-blue-900/[0.1] md:grid-cols-4 md:gap-8 lg:grid-cols-5 lg:items-stretch lg:gap-12">
